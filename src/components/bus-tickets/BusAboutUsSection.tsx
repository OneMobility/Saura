...
const BusAboutUsSection = () => {
  return (
    <section className="py-12 px-4 md:px-8 lg:px-16 bg-white text-bus-foreground">
      <div className="max-w-6xl mx-auto p-8 bg-bus-primary rounded-lg shadow-md"> {/* Cambiado a bg-bus-primary */}
        <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
          {/* Columna del Contenido de Texto (a la izquierda) */}
          <div className="text-center lg:text-left mb-8 lg:mb-0">
            <h2 className="text-3xl md:text-4xl font-bold text-bus-primary-foreground mb-6"> {/* Cambiado a text-bus-primary-foreground */}
              Sobre <span className="text-bus-secondary">Saura</span> Bus {/* Añadido span para 'Saura' */}
            </h2>
            <p className="text-lg mb-8 text-bus-primary-foreground"> {/* Cambiado a text-bus-primary-foreground */}
            ...
            <Button asChild className="bg-bus-secondary hover:bg-bus-secondary/90 text-bus-secondary-foreground"> {/* Cambiado a bg-bus-secondary */}
