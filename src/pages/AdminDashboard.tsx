...
const AdminDashboard = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100"> {/* Contenedor flex para la barra lateral y el contenido principal */}
      <AdminSidebar /> {/* El nuevo componente de la barra lateral */}

      <div className="flex flex-col flex-grow"> {/* Área de contenido principal */}
