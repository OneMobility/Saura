...
import PaymentSettings from '@/components/admin/settings/PaymentSettings'; // NEW
      ...
      <div className="flex flex-col flex-grow">
        ...
        <main className="flex-grow container mx-auto px-4 py-8 md:py-12">
          <Tabs defaultValue="slideshow" className="w-full">
            <TabsList className="grid w-full grid-cols-4 lg:grid-cols-8 gap-2 h-auto"> {/* Ajustado para más pestañas */}
              <TabsTrigger value="slideshow">Slideshow</TabsTrigger>
              <TabsTrigger value="seo">SEO</TabsTrigger>
              <TabsTrigger value="social-media">Redes</TabsTrigger>
              <TabsTrigger value="agency-info">Agencia</TabsTrigger>
              <TabsTrigger value="payments">Pagos</TabsTrigger> {/* NEW */}
              <TabsTrigger value="about-us">Sobre Nosotros</TabsTrigger>
              <TabsTrigger value="policies-terms">Legal</TabsTrigger>
            ...
            <TabsContent value="payments"> {/* NEW */}
              <PaymentSettings />
            </TabsContent>
