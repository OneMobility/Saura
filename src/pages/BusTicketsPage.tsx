    ...
    return (
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow py-12 px-4 md:px-8 lg:px-16 bg-white flex items-center justify-center">
          ...
          <p className="ml-4 text-gray-700 text-xl">Cargando tours de autobús...</p>
        </main>
        <Footer />
      </div>
    );
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 md:py-12">
        ...
        {busTours.length === 0 ? (
          <p className="text-center text-gray-600 text-lg">No hay tours de autobús disponibles en este momento.</p>
        ) : (
            ...
            {busTours.map((tour) => (
              <div key={tour.id} className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col">
                ...
                <div className="p-4 flex-grow">
                  ...
                  <p className="text-lg font-bold text-rosa-mexicano">
                ...
                <div className="p-4 border-t border-gray-100">
                  <Button
                    ...
                    className="w-full bg-rosa-mexicano hover:bg-rosa-mexicano/90 text-white"
                  >
                    Reservar Boleto
                  </Button>
                </div>
